...
<html lang="en">
    <head>
        ...
        <link href="http://localhost/PHP/blog/css/styles.css" rel="stylesheet" />
    </head>
    <body>
        <!-- Navigation-->
        ...
        <!-- Page Header-->
        <header class="masthead" style="background-image: url('http://localhost/PHP/blog/assets/img/home-bg.jpg')">
