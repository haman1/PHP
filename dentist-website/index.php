...
$conn = mysqli_connect('localhost','matigari','','contactsdb') or die('connection failed');
...
if(isset($_POST['submit'])){
   ...
   $insert = mysqli_query($conn, "INSERT INTO `contacts`(name, email, phone, date) VALUES('$name','$email','$phone','$date')") or die('query failed');
...
<section class="footer">
   ...
   <div class="box-container container">
      ...
      <div class="box">
         ...
         <h3>email address</h3>
         <p>dentalglos@gmail.com</p>
      </div>

   </div>

   <div class="credit"> &copy; copyright @ <?php echo date('Y'); ?> by <span>Arme</span>  </div>
